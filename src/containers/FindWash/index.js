...
class FindWashScreen extends Component {
  ...
  setInitialCoordinates = () => {
    Geolocation.getCurrentPosition( async (info) => {
      ...
      const loc = await  this.getLocationName(info.coords.latitude, info.coords.longitude);
  ...
  renderPickup = () => {
    ...
    console.log("pick up",pickupvalue)
    return (
      <View
        style={{
          width: Metrics.screenWidth,
              ...
              this.state.pickup.longitude !== null && (
                <MapView
                  ...
                  onPress={e => {
                    ...
                    let loc =  await  this.getLocationName( e.nativeEvent.coordinate.latitude, e.nativeEvent.coordinate.longitude);
                      this.setState({
                        pickupvalue:loc,
                        dropoffvalue:loc})
                    });
